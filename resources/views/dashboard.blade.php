<x-layout :pageScripts="['resources/js/alert.js']">
    ...
    <div class="dashboard-main-body">
        ...
        <div class="row row-cols-xxxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4">
            ...
            <x-dashboard-card title="Total Subscription" value="15,000" icon="fa-solid:award"
                bgColor="bg-gradient-start-2" iconBg="bg-purple" changeValue="-800" changeType="danger"
                changeLabel="Last 30 days subscription" />

            <x-dashboard-card title="Total Free Users" value="5,000" icon="fluent:people-20-filled"
                bgColor="bg-gradient-start-3" iconBg="bg-info" changeValue="+200" changeType="success"
                changeLabel="Last 30 days users" />

            <x-dashboard-card title="Total Income" value="$42,000" icon="solar:wallet-bold"
                bgColor="bg-gradient-start-4" iconBg="bg-success-main" changeValue="+$20,000" changeType="success"
                changeLabel="Last 30 days income" />

            <x-dashboard-card title="Total Expense" value="$30,000" icon="fa6-solid:file-invoice-dollar"
                bgColor="bg-gradient-start-5" iconBg="bg-red" changeValue="+$5,000" changeType="success"
