    ...
    <div class="sidebar-menu-area">
        <ul class="sidebar-menu" id="sidebar-menu">
            ...
            <x-sidebar.dropdown icon="hugeicons:invoice-03" title="Invoice" :items="[
                ...
                ['href' => 'invoice-preview.html', 'label' => 'Preview', 'color' => 'text-warning-main'],
                ['href' => 'invoice-add.html', 'label' => 'Add new', 'color' => 'text-success-main'],
                ['href' => 'invoice-edit.html', 'label' => 'Edit', 'color' => 'text-info-main'],
            ]" />
            ...
            <x-sidebar.group-title>UI Elements</x-sidebar.group-title>
